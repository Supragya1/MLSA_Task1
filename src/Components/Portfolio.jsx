...
const projectList = [
  ...
  },
  {
    ...
    description:
      `-	Developed an Android application aimed at improving healthcare accessibility in both urban and rural areas of India.      -	User Perspective:
        ...
        <div className="container">
          {projectList.map((project) => (
            <div className="box" key={project.title}>
              ...
              <p className="small" style={{ textAlign: "justify", height: "170px", overflow:"auto"}}>{project.description}</p>
            </div>
          ))}
        </div>
      </div>
